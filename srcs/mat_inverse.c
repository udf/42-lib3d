...
/*   Updated: 2018/07/27 22:08:58 by mhoosen          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	mat_inverse(t_mat inv, const t_mat src)
{
	...
	mat_set_row(inv[0], u.x, v.x, w.x, 0);
	mat_set_row(inv[1], u.y, v.y, w.y, 0);
	mat_set_row(inv[2], u.z, v.z, w.z, 0);
	mat_set_row(inv[3], p3d_dot(u, t), p3d_dot(v, t), p3d_dot(w, t), 1);
}
